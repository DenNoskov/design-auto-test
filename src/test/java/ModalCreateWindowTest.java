...
public class ModalCreateWindowTest {

    @Test
    @DisplayName("Проверка поля поиска города/ПВЗ")
    public void checkingTheSearchFieldTest() {
        step("Поиск осуществляется как по городам, так и по ПВЗ", () -> {});
    }

    @Test
    @Story("Проверка чек-боксов города/ПВЗ")
    @DisplayName("Проверка чек-бокса города")
    public void checkingTheCityCheckboxTest() {
    ...
    @Test
    @Story("Проверка чек-боксов города/ПВЗ")
    @DisplayName("Проверка чек-бокса ПВЗ")
    public void checkingTheCheckboxPVZTest() {
    ...
    public void checkingTheCheckboxPackingWallsTest() {
    ...
    @Test
    @DisplayName("Проверка иных элементов модального окна")
    public void checkingOtherModalElementsTest() {
